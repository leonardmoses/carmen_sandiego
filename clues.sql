...
-- Write SQL query here
SELECT countrycode, language, percentage FROM countrylanguage WHERE language='Italian' ORDER BY percentage DESC;
...
SELECT countrycode, name, population FROM city WHERE population='91084';